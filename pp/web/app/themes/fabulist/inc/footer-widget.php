...
class Fabulist_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'fabulist';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'fabulist' ), $i ),
...
// Initialize.
$fabulist_footer_widgets = new Fabulist_Footer_Widgets();
