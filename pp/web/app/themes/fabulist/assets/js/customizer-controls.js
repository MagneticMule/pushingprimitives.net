...
jQuery( document ).ready(function($) {
    ...
    $( document ).on( 'click', '.customize_multi_add_field', fabulist_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', fabulist_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', fabulist_customize_multi_remove_field )
    ...
    function fabulist_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            fabulist_customize_multi_write( $control );
    }

    function fabulist_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        fabulist_customize_multi_write( $control );
    }

    function fabulist_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function fabulist_customize_multi_write( $element) {
